    ...
    public partial class InitClean : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Movies",
                columns: new[] { "Id", "Description", "DurationMinutes", "Genre", "Language", "Rating", "ReleaseDate", "Title" },
                values: new object[,]
                {
                    { 1, null, 148, null, null, null, null, "Inception" },
                    { 2, null, 152, null, null, null, null, "The Dark Knight" }
                });

            migrationBuilder.InsertData(
                table: "Theaters",
                columns: new[] { "Id", "Location", "Name" },
                values: new object[] { 1, "", "IMAX Central" });

            migrationBuilder.InsertData(
                table: "Screens",
                columns: new[] { "Id", "Name", "TheaterId", "TotalSeats" },
                values: new object[] { 1, "Screen 1", 1, 0 });

            migrationBuilder.InsertData(
                table: "Seats",
                columns: new[] { "Id", "IsDisabled", "Number", "Row", "ScreenId" },
                values: new object[,]
                {
                    { 1, false, 1, "A", 1 },
                    { 2, false, 2, "A", 1 }
            ...
            migrationBuilder.InsertData(
                table: "Shows",
                columns: new[] { "Id", "MovieId", "Price", "ScreenId", "StartsAtUtc" },
                values: new object[,]
                {
